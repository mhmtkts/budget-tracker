...
const Header = () => {
  ...
  return (
    <>
      ...
      <header className="fixed top-0 right-0 z-40 bg-white dark:bg-gray-800 shadow-md px-4 md:px-6 py-4 flex justify-between items-center ml-0 md:ml-60 w-full md:w-[calc(100%-15rem)]">
